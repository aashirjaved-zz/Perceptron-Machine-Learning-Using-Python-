...
pl.scatter(X[:50, 0], X[:50, 1], color='black', marker='o', label='setosa')
pl.scatter(X[50:100, 0], X[50:100, -1], color='green', marker='x', label='versicolor')
pl.xlabel('sapel length')
...
ppn.fit(X, y)
print(ppn.erros)
pl.plot(range(1, len(ppn.erros) + 1), ppn.erros)
pl.xlabel('Attempts')
pl.ylabel('Number of Missclassification')
pl.show()
